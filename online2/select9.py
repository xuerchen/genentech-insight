...
# A, paths
train=['../input/trainx.csv','../noleak/dp_encode1.csv','../noleak/dp_encode3.csv','../noleak/dp_encode4.csv']
test=train
trainsvm=[]#['../../boat/claim/full_line_claim_id_train_small.svm']
testsvm=trainsvm
submission = 'predictions/select9cv.csv'  # path of to be outputted submission file
weightmap={}
screenmap={}
countmap={}
feamap={}
...
name='../input/procedure_code.csv'
for c,row in enumerate(csv.DictReader(open(name))):
    pro[row['procedure_code']]=row['procedure_description']

print 'important features:',len(feamap)
f=open('feamap9.csv','w')
