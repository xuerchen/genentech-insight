...
# A, paths
train=['../input/trainx.csv','../input/dp_encode1.csv','../input/dp_encode3.csv','../input/dp_encode4.csv']
test=train
trainsvm=[]#['../../boat/claim/full_line_claim_id_train_small.svm']
testsvm=trainsvm
submission = 'predictions/select8cv.csv'  # path of to be outputted submission file
weightmap={}
screenmap={}
countmap={}
feamap={}
