...
def get(dline,pline):
    ...
    for d in dd:
        ...
        tmp.append(x)
    return ' '.join(tmp)
diag=csv.DictReader(open('diagnosis_noleak_code_group_train.csv'))

name='procedure_noleak_code_group_train.csv'
fo=open('dp_encode3.csv','w')
